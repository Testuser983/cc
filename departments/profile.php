...
$query=mysqli_query($con,"update department set fullName='$fname',contactNo='$contactno' where deptEmail='".$_SESSION['d_login']."'");
if($query)
{
...
<html lang="en">
  <head>
    ...
    <title>CCP | User Change Password</title>
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      ...
                      <?php }?>
 <?php $query=mysqli_query($con,"select * from department where deptEmail='".$_SESSION['d_login']."'");
...
<div class="form-group">
 ...
 <label class="col-sm-2 col-sm-2 control-label">Department Email </label>
 <div class="col-sm-4">
<input type="email" name="deptemail" required="required" value="<?php echo htmlentities($row['deptEmail']);?>" class="form-control" readonly>
 </div>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Dept Photo</label>
<div class="col-sm-4">
<?php $deptphoto=$row['deptImage'];
if($deptphoto==""):
?>
<img src="deptimages/noimage.png" width="256" height="256" >
<a href="update-image.php">Change Photo</a>
<?php else:?>
	<img src="deptimages/<?php echo htmlentities($deptphoto);?>" width="256" height="256">
	<a href="update-image.php">Change Photo</a>
<?php endif;?>
</div>
