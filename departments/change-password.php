...
{
$sql=mysqli_query($con,"SELECT password FROM  department where password='".md5($_POST['password'])."' && deptEmail='".$_SESSION['login']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update department set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where deptEmail='".$_SESSION['login']."'");
...
<html lang="en">
  <head>
    ...
    <title>CCP | Department Change Password</title>
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Department Change Password</h4>
