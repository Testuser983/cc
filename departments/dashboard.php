                        ...
                        <div>
                  		...
                  		<div class="col-md-2 col-sm-2 box0">
                  			<div class="box1">
                                ...
                                <?php 
                         $d_id=$_SESSION['d_id'];
$rt = mysqli_query($con,"SELECT * FROM test where  status is null and department='$d_id'");
...
{?>
                  ...
                  <span class="li_news"></span>
                    <?php 
  $status="in Process";                   
$rt = mysqli_query($con,"SELECT * FROM test where status='$status' and department=$d_id");
$num1 = mysqli_num_rows($rt);
{?>
                  <h3><?php echo htmlentities($num1);?></h3>
                        </div>
