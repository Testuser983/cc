...
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/ccp/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
											...
											<td> 
											<a href="javascript:void(0);" onClick="popUpWindo('http://localhost/ccp/admin/for.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
											 <button type="button" class="btn btn-primary">FORWARD</button></a></td>
											<td colspan="4"> 
